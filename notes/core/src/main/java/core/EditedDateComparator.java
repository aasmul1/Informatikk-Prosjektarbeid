...
public class EditedDateComparator implements Comparator<Note>{
    ...
    * @return a negative integer, zero, or a positive integer if the last edited date of the first note is 
    * is respectively before, equal to, or after last edited date of the second note
