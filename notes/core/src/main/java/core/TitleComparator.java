...
public class TitleComparator implements Comparator<Note>{
    ...
    * @return a negative integer, zero, or a positive integer if the title of the first note is 
    * is lexicographically before, equal to, or after the title of the second note when ignoring case differences.
