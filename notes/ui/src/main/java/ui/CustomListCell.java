...
public class CustomListCell extends ListCell<Note> {
    ...
    /**
     * Constructs a CustomListCell, creating the layout for displaying a Note.
     * The cell consists of a VBox containing a title and text, and an HBox
     * for displaying the creation date. The title is set to wrap to the next line
     * when it exceeds a maximum width, and it's displayed in a bold font.
     */
    ...
    /**
     * Updates the ListCell with the provided Note object. If the Note is not
     * null and the cell is not empty, it sets the title, text, and creation date
     * to their respective values. The title text is set to wrap to the next line
     * if it exceeds a maximum width, and it's displayed in a bold font.
     *
